  ...
  return (
    <div className="p-8 space-y-8 bg-slate-50 dark:bg-slate-950 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "KASA BAKİYESİ", val: "42.850,00 ₺", sub: "Ana kasa ve çekmece toplamı", icon: Landmark, color: "text-blue-600", bg: "bg-blue-50 dark:bg-blue-900/20" },
          { label: "GÜNLÜK GELİR", val: "8.420,00 ₺", sub: "Bugünkü toplam nakit girişi", trend: "+12%", icon: TrendingUp, color: "text-emerald-600", bg: "bg-emerald-50 dark:bg-emerald-900/20" },
          { label: "BEKLEYEN POS", val: "15.200,45 ₺", sub: "Provizyondaki toplam tutar", icon: CreditCard, color: "text-blue-400", bg: "bg-blue-50 dark:bg-blue-900/20" },
          { label: "AYLIK NET KÂR", val: "112.900 ₺", sub: "Tüm giderler sonrası", trend: "+8.4%", icon: BarChart3, color: "text-emerald-500", bg: "bg-emerald-50 dark:bg-emerald-900/20" },
        ].map((s, i) => (
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm flex flex-col">
          ...
          <div className="flex-1 space-y-8">
            {[
              ...
              { label: "2. El Ticareti", val: "6.150 ₺", p: "w-[15%]", color: "bg-emerald-500" },
            ].map((r, i) => (
          ...
          <div className="mt-10 p-5 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-800 flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <span className="text-xs font-black text-blue-700 dark:text-blue-300 mt-0.5">Ekran Onarımı %10 İndirim</span>
            </div>
