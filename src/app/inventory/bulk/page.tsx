    ...
    <div className="flex flex-col min-h-screen bg-slate-950 text-slate-200">
      ...
      <section className="px-8 pt-8 pb-6 flex justify-between items-end">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Envanterinizi hızlıca güncelleyin ve yeni parçaları sisteme dahil edin.</p>
        </div>
      ...
      <div className="px-8 flex-1 overflow-auto no-scrollbar pb-32">
          ...
          <table className="w-full text-left border-collapse">
            <thead className="bg-slate-900 sticky top-0 z-10 border-b border-slate-800">
              <tr>
                ...
                <th className="px-4 py-4 text-[10px] font-black uppercase tracking-widest text-slate-500 text-right">Kâr %</th>
              </tr>
            </thead>
              ...
              <tr className="hover:bg-slate-800/20 transition-colors bg-blue-500/5">
                ...
                <td className="px-4 py-3">
                  <div className="flex items-center gap-2 relative group">
                    ...
                    <input className="bg-slate-800/50 border border-blue-500/30 rounded-lg px-2 py-1 focus:ring-1 focus:ring-blue-500 text-xs text-slate-200 w-full placeholder-slate-600 transition-all outline-none" placeholder="Barkod tara..." type="text" />
                  </div>
                </td>
                <td className="px-4 py-3">
                  <input className="bg-transparent border-none focus:ring-0 text-sm text-slate-500 p-0 w-full italic" placeholder="Ürün adını girin..." type="text" />
                </td>
        ...
        <div className="mt-8 flex gap-6">
          {[
            ...
            { label: "Tahmini Kâr", value: "14.250,00 ₺", icon: LineChart, color: "text-amber-500", bg: "bg-amber-500/10" },
          ].map((m, i) => (
      ...
      <footer className="fixed bottom-0 left-64 right-0 bg-slate-950/80 backdrop-blur-xl border-t border-slate-800/50 p-6 z-30 shadow-2xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 mt-0.5">
                ...
                <span className="text-xs font-bold text-slate-300">Tarayıcı Çevrimiçi: COM4</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-4">
            <button className="px-6 py-2.5 text-xs font-black text-slate-500 hover:text-white transition-colors uppercase tracking-[0.2em]">İptal</button>
