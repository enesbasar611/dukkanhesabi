    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-slate-100 antialiased font-inter tracking-tight">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <h2 className="text-4xl font-black tracking-tighter text-slate-900 dark:text-white leading-none uppercase">Kampanya Yönetimi</h2>
        </div>
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="flex items-center gap-3 bg-white dark:bg-slate-900 px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl border border-slate-100 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 transition-all active:scale-95 group">
            ...
            Küresel ROI&#39;yi Görüntüle
          </button>
        </div>
      </div>

      {/* Ana Düzen: Asimetrik Izgara */}
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        {/* Sol Sütun: Oluşturucu (Geniş) */}
        <div className="xl:col-span-8 space-y-8">
          {/* Adım 1: Hedef Kitle ve Şablon Seçimi */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-2xl shadow-black/5 border border-slate-100 dark:border-slate-800">
              ...
              <div className="space-y-3">
                ...
                <TemplateButton icon={PartyPopper} label="Festival Tebrikleri" variant="purple" />
              </div>
            </div>
          </div>

          {/* Adım 2: Mesaj Oluşturucu */}
            ...
            <div className="p-10">
              ...
              <div className="mt-8 flex flex-col md:flex-row md:items-center justify-between gap-6 border-t border-slate-100 dark:border-slate-800 pt-8">
                <div className="flex items-center gap-8 text-[10px] font-black tracking-[0.2em] text-slate-400 uppercase">
                  <span>KARAKTER: <span className="text-blue-600">142/160</span></span>
                  <span>KREDİ: <span className="text-blue-600">1.0</span></span>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div className="flex shadow-2xl shadow-blue-600/20">
                    <button className="px-8 py-3 rounded-l-2xl text-[10px] font-black uppercase tracking-widest bg-blue-600 text-white hover:bg-blue-500 transition-all border-r border-white/10">Şimdi Gönder</button>
          ...
          {/* Geçmiş Kampanyalar Tablosu */}
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-black tracking-tight uppercase tracking-widest">Son Aktiviteler</h3>
              <button className="text-[10px] font-black uppercase tracking-[0.2em] text-blue-600 hover:underline">Analitiği Dışa Aktar</button>
            </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/50 dark:bg-slate-950/20 text-[10px] font-black tracking-[0.2em] text-slate-400 uppercase">
                    <th className="px-8 py-6">Kampanya Profili</th>
                    <th className="px-8 py-6">Durum</th>
                    <th className="px-8 py-6">Performans</th>
                    <th className="px-8 py-6">Açılma Oranı</th>
                    <th className="px-8 py-6 text-right">Tarih</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  <CampaignRow
                    name="Bayram Özel Teklifi"
                    status="Tamamlandı"
                    delivery="%98,2"
                    open="%42,5"
                    date="12 Eki 2023"
        ...
        {/* Sağ Sütun: Önizleme ve Analitik (Kenar Çubuğu) */}
        <div className="xl:col-span-4 space-y-8">
            ...
            <div className="h-full w-full bg-[#e5ddd5] rounded-[2.5rem] overflow-hidden flex flex-col shadow-inner relative z-10">
              ...
              <div className="bg-[#075e54] p-5 pt-10 text-white flex items-center gap-4 relative">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-[10px] opacity-70 font-bold uppercase tracking-widest mt-1">çevrimiçi</p>
                </div>
                <div className="flex gap-4">
              ...
              <div className="flex-1 p-4 space-y-5 custom-scrollbar overflow-y-auto">
                <div className="mr-auto bg-[#dcf8c6] p-4 rounded-2xl rounded-tl-none text-[11px] shadow-sm max-w-[85%] font-medium text-slate-800 relative">
                  <p className="mb-1 font-black">Merhaba John! 👋</p>
                  <p>iPhone 13 Pro cihazınız TechAtelier Merkez şubemizde teslim alınmaya hazırdır. Lütfen #4920 numaralı fişinizi yanınızda getirin.</p>
                  <span className="text-[8px] text-slate-400 font-black uppercase float-right mt-2">11:42 ÖÖ ✓✓</span>
                </div>
                ...
                <div className="mr-auto bg-white p-4 rounded-2xl rounded-tl-none text-[11px] shadow-sm max-w-[85%] border-l-4 border-blue-500 font-medium text-slate-800 relative">
                  <div className="flex flex-col">
                    ...
                    <p className="font-black mb-1">Yeni Model Duyurusu! 🚀</p>
                    <p className="text-slate-600 font-bold">iPhone 15 Pro stoklarımızda. Eski cihazınızı getirin ve %40&#39;a varan indirimden yararlanın. Sınırlı stok!</p>
                    <span className="text-[8px] text-slate-400 font-black uppercase float-right mt-2">Şimdi ✓</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 bg-[#f0f0f0] flex items-center gap-3">
                <div className="flex-1 bg-white rounded-full px-5 py-2 flex items-center justify-between shadow-inner">
                  ...
                  <span className="text-xs text-slate-300 flex-1 px-4 font-bold">Mesaj</span>
          ...
          <div className="bg-slate-900 p-10 rounded-[2.5rem] text-white shadow-2xl shadow-blue-900/10 space-y-8 relative overflow-hidden">
            ...
            <button className="w-full py-4 bg-white/10 hover:bg-white/20 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] transition-all active:scale-95 border border-white/5 relative z-10">Kapasiteyi Yükselt</button>
          </div>
          ...
          <div className="bg-blue-600/5 border border-blue-500/10 p-6 rounded-[2rem] flex gap-5 shadow-inner">
            ...
            <div>
              <p className="text-xs font-black text-blue-600 mb-1 uppercase tracking-widest">Profesyonel İpucu</p>
              <p className="text-[11px] text-slate-500 font-bold leading-relaxed uppercase tracking-tight">
                Mesajlarınızı <span className="font-mono bg-white dark:bg-slate-800 px-1.5 py-0.5 rounded text-blue-500">{"{ad}"}</span> ile kişiselleştirmek, teknik perakende sektöründe açılma oranlarını %28&#39;e kadar artırır.
              </p>
            </div>
          </div>
        </div>
