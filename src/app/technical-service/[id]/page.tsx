...
const timelineData = [
  { status: "Kayıtlı", title: "Alındı ve Kaydedildi", desc: "Cihaz Sarah tarafından sisteme işlendi", time: "10:24 ÖÖ", icon: CheckCircle, color: "text-emerald-400", bg: "bg-emerald-500/20" },
  { status: "İnceleme", title: "Teknik İnceleme", desc: "Ekran dokunmatik hatası onaylandı", time: "11:15 ÖÖ", icon: CheckCircle, color: "text-emerald-400", bg: "bg-emerald-500/20" },
  { status: "Onarımda", title: "Onarım Aşamasında", desc: "Ekran modülü ve su sızdırmazlık contası değişiyor", time: "AKTİF", icon: Wrench, color: "text-blue-400", bg: "bg-blue-600", active: true },
  { status: "KK", title: "Kalite Kontrol", desc: "Son stres testi ve sensör kontrolü", time: "BEKLEMEDE", icon: CheckCircle, color: "text-slate-500", bg: "bg-slate-800", pending: true },
];
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-[10px] text-slate-500 uppercase font-extrabold tracking-widest mb-1">Pil</p>
                  <p className="text-sm text-slate-900 dark:text-slate-200 font-semibold">%89 Sağlık</p>
                </div>
                <div>
                  <p className="text-[10px] text-slate-500 uppercase font-extrabold tracking-widest mb-1">Durum</p>
            ...
            <div className="space-y-4">
              <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-100 dark:border-slate-800">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-[10px] px-1.5 py-0.5 rounded bg-orange-100 text-orange-600 dark:bg-orange-900/30 font-black uppercase">Kritik</span>
                </div>
                <p className="text-xs text-slate-700 dark:text-slate-300 leading-relaxed italic">
                  &quot;FaceID modülü son derece hassastı. Ayırmak için 180 saniye boyunca 75C ısı kullanıldı. Montajdan sonra üst yapışkan contanın değiştirilmesi önerilir.&quot;
                </p>
              </div>
              <textarea
                value={note}
        ...
        <div className="lg:col-span-3 space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm">
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/50">
              <h3 className="text-slate-900 dark:text-white font-bold text-sm">Bileşenler & Parçalar</h3>
            </div>
            <div className="divide-y divide-slate-100 dark:divide-slate-800">
              {[
                { name: "iPhone 14 PM Ekran", desc: "OEM Kalite • Stokta", price: "329,00" },
                { name: "Ekran Yapıştırıcı", desc: "Standart Onarım Kiti", price: "12,00" },
                { name: "Ekran Koruyucu", desc: "Sadakat Hediyesi", price: "0,00", free: true },
              ].map((part, i) => (
