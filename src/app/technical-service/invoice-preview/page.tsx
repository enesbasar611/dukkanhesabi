...
export default function InvoicePreview() {
  ...
  return (
    <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-slate-950">
      ...
      <div className="w-80 bg-slate-900 border-r border-slate-800 p-6 flex flex-col gap-8 overflow-y-auto custom-scrollbar">
        <div>
          <h3 className="text-[10px] font-black text-blue-500 uppercase tracking-[0.2em] mb-4">Output Format</h3>
        ...
        <div>
          ...
          <div className="space-y-4">
            ...
            <Toggle label="Itemized Discounts" enabled={itemizedDiscounts} setEnabled={setItemizedDiscounts} />
            <Toggle label="Store Terms & Conditions" enabled={storeTerms} setEnabled={setStoreTerms} />
            <Toggle label="Digital QR Code" enabled={digitalQR} setEnabled={setDigitalQR} />
          </div>
        </div>
      ...
      <div className="flex-1 bg-slate-950 relative overflow-hidden flex items-center justify-center p-12 overflow-y-auto custom-scrollbar">
        ...
        <div className="bg-white text-slate-900 w-[600px] min-h-[840px] shadow-2xl shadow-black p-12 flex flex-col relative rounded-sm transform scale-90 origin-top">
          ...
          <header className="flex justify-between items-start mb-12 relative z-10">
            ...
            <div className="text-right">
              <h1 className="text-5xl font-black text-slate-100 uppercase tracking-tighter leading-none mb-4">Invoice</h1>
              <div className="space-y-0.5">
          ...
          <div className="grid grid-cols-2 gap-12 mb-12 relative z-10">
            ...
            <div>
              ...
              <div className="text-xs leading-relaxed font-bold text-slate-600">
                ...
                <p>42 Industrial Way, Suite 800</p>
                <p>San Francisco, CA 94107</p>
                <p>contact@techatelier.io</p>
              </div>
            </div>
            <div>
              <p className="text-[10px] font-black text-blue-600 uppercase tracking-[0.2em] mb-3">Bill To</p>
              <div className="text-xs leading-relaxed font-bold text-slate-600">
                <p className="text-slate-900 font-black">Aether Dynamics Corp.</p>
                <p>Attn: Sarah Jenkins</p>
                <p>909 Innovation Blvd</p>
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b-2 border-slate-900">
                  ...
                  <th className="py-4 text-right text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Total</th>
                </tr>
              </thead>
              <tbody className="text-xs font-bold divide-y divide-slate-100">
                ...
                <tr className="group">
                  <td className="py-5">
                    <p className="font-black text-slate-900">High-Flow Tungsten Nozzles</p>
                    <p className="text-[10px] text-slate-500 mt-1 italic font-medium tracking-tight">Part #XT-90-2 (0.4mm variant)</p>
                  </td>
                  <td className="py-5 text-center font-mono">3</td>
                  <td className="py-5 text-right font-mono">$85.00</td>
                  <td className="py-5 text-right font-black tracking-tighter text-sm">$255.00</td>
                ...
                <tr className="group">
                  <td className="py-5">
                    <p className="font-black text-slate-900">System Firmware Upgrade</p>
                    <p className="text-[10px] text-slate-500 mt-1 italic font-medium tracking-tight">OS v4.2 Deployment with cloud sync integration</p>
                  </td>
                  <td className="py-5 text-center font-mono">1</td>
                  <td className="py-5 text-right font-mono">$120.00</td>
                  <td className="py-5 text-right font-black tracking-tighter text-sm">$120.00</td>
          ...
          <footer className="mt-12 flex justify-between items-end border-t-2 border-slate-900 pt-10 relative z-10">
            ...
            <div className="w-52 space-y-2.5">
              ...
              <div className="flex justify-between text-xs font-bold text-slate-400 uppercase tracking-widest">
                <span>VAT (8.5%)</span>
                <span className="text-slate-900">$70.13</span>
              </div>
              <div className="flex justify-between pt-4 border-t-2 border-slate-900 mt-2">
                <span className="text-sm font-black uppercase tracking-[0.1em]">Total due</span>
                <span className="text-xl font-black text-slate-900 tracking-tighter">$853.88</span>
              </div>
            </div>
          </footer>
