  ...
  return (
    <div className="px-8 py-8 max-w-6xl mx-auto pb-32">
      <div className="mb-8">
        ...
        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">Yeni Cihaz Kaydı</h2>
      </div>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-1.5">
                <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider ml-1">E-posta Adresi (Opsiyonel)</label>
                <input className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl p-3 text-sm focus:ring-2 focus:ring-blue-500/20 outline-none" placeholder="musteri@ornek.com" type="email" />
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 space-y-3">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {['Çizik', 'Ezilme', 'Ekran Çatlak', 'Sıvı Teması'].map((condition) => (
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-4">
                  {['Şarj Aleti', 'Kutu', 'Kılıf', 'SIM Kart', 'Hafıza Kartı'].map((item) => (
        ...
        <div className="col-span-12 lg:col-span-4 space-y-8">
          ...
          <section className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-2 mb-6">
              ...
              <h3 className="font-bold text-lg">Hizmet Teklifi</h3>
            </div>
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider ml-1">Ön Ödeme</label>
                <div className="relative">
                  <span className="absolute left-3 top-1/2 -translate-y-1/2 font-bold text-slate-400">₺</span>
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold text-slate-500 uppercase tracking-wider ml-1">Tahmini Teslim Tarihi</label>
          ...
          <section className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800">
            ...
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-2xl p-8 flex flex-col items-center justify-center text-center group hover:border-blue-500 transition-colors cursor-pointer">
              ...
              <p className="text-xs font-bold text-slate-900 dark:text-white mb-1">Fotoğraf Yükle</p>
              <p className="text-[10px] text-slate-500 uppercase">Mevcut hasarların fotoğraflarını çekin</p>
