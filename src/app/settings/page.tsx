        ...
        <div className="lg:col-span-9 space-y-8">
          ...
          <section className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 shadow-sm">
            <div className="flex items-center gap-6 mb-10">
              <div className="w-20 h-20 rounded-3xl bg-blue-600 flex items-center justify-center text-white text-2xl font-black shadow-xl">AR</div>
              <div>
                <h3 className="text-xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Alex Rivera</h3>
                <p className="text-sm font-bold text-blue-600 uppercase tracking-widest">Mağaza Sahibi / Yönetici</p>
              </div>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <SettingsInput label="Ad Soyad" value="Alex Rivera" />
              <SettingsInput label="E-posta Adresi" value="alex@techatelier.com" />
