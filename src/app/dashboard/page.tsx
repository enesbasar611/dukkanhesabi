...
const metrics = [
  { label: "Günlük Satış", val: "1.250,00 ₺", trend: "+12%", icon: DollarSign, color: "text-emerald-600", bg: "bg-emerald-50 dark:bg-emerald-900/20" },
  ...
  { label: "Kritik Stok", val: "3", tag: "Düşük", icon: AlertTriangle, color: "text-red-600", bg: "bg-red-50 dark:bg-red-900/20" },
...
const transactions = [
  { name: "Ahmet Yılmaz", date: "14 Eki, 14:30", op: "iPhone 13 Ekran Tamiri", amount: "120,00 ₺", status: "Ödendi" },
  { name: "Selin Demir", date: "14 Eki, 11:15", op: "Samsung S22 Batarya", amount: "85,00 ₺", status: "Beklemede" },
  { name: "Can Özcan", date: "13 Eki, 16:45", op: "Şarj Soketi Temizliği", amount: "35,00 ₺", status: "Ödendi" },
];

const serviceRecords = [
  { device: "iPhone 14 Pro Max", user: "Ahmet R.", issue: "Kırık Cam", status: "Devam Ediyor", tech: "Sam Wilson", icon: Smartphone },
  { device: "iPad Air (M1)", user: "Alice P.", issue: "Boot Loop", status: "Hazır", tech: "Alex R.", icon: Tablet },
        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm">
          ...
          <div className="relative w-52 h-52 mx-auto mb-10 group cursor-pointer">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              ...
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Toplam Cihaz</span>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col">
          <div className="p-8 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50 dark:bg-slate-950/30">
            ...
            <button className="text-blue-600 text-[10px] font-black uppercase tracking-widest hover:underline decoration-2">Tüm Kayıtlar</button>
          </div>
            ...
            {serviceRecords.map((r, i) => (
              <div key={i} className="p-8 flex items-center justify-between hover:bg-slate-50/50 dark:hover:bg-slate-800/50 transition-colors">
                ...
                <div className="text-right">
                  ...
                  <p className="text-[9px] text-slate-400 font-black uppercase tracking-tighter">Tek: {r.tech}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <div className="bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-800">
        <div className="flex justify-between items-center mb-10">
          <div>
            ...
            <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mt-1">Bu ay en çok hareket gören parçalar</p>
          </div>
        </div>
